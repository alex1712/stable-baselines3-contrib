...
from sb3_contrib import QRDQN, TQC, TRPO, MaskablePPO, RecurrentPPO, RecurrentMaskablePPO
...
@pytest.mark.parametrize("model_class", [TRPO, MaskablePPO, RecurrentPPO, RecurrentMaskablePPO, QRDQN, TQC])
...
def test_image_like_input(model_class, normalize_images):
    ...
    if model_class == MaskablePPO or model_class == RecurrentMaskablePPO:
